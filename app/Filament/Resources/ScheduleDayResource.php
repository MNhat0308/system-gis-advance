...
class ScheduleDayResource extends Resource
{
    ...
    protected static ?string $slug = 'schedule-days';
        ...
        return $form
            ->schema([
                ...
                Placeholder::make('created_at')
                    ->label('Created Date')
                    ->content(fn(?ScheduleDay $record): string => $record?->created_at?->diffForHumans() ?? '-'),

                Placeholder::make('updated_at')
                    ->label('Last Modified Date')
                    ->content(fn(?ScheduleDay $record): string => $record?->updated_at?->diffForHumans() ?? '-'),
            ]);
    }
